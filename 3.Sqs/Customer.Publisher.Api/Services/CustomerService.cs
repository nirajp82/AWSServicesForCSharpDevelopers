...
using Customer.Publisher.Api.Mapping;
...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Domain.Customer customer, CancellationToken cts)
    {
    ...
    public async Task<Domain.Customer?> GetAsync(Guid id)
    {
    ...
    public async Task<bool> UpdateAsync(Domain.Customer customer, CancellationToken cts)
    {
        var customerDto = customer.ToCustomerDto();
